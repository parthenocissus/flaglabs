...
class FlagLayout:
    ...
    def diamond(self):
        ...
        self.sd = self.fsc.center(scale_factor=uniform(0.2, 0.4))
    ...
    def chevron(self):
        ...
        self.sd = self.fsc.default_left_or_right()
    ...
    def hoist_stripe(self):
        ...
        self.sd = self.fsc.center_right(scale_factor=uniform(0.4, 0.7), width_fraction=wf)
    ...
    def bottom_stripe(self):
        ...
        self.sd = self.fsc.center_down(scale_factor=sf, height_fraction=hf)
    ...
    def top_stripe(self):
        ...
        sf = uniform(0.3, 0.6)
        cd = (margin / self.h) / 2
        self.sd = self.fsc.default_canton_center_down(scale_factor=sf, height_fraction=hf,
                                                      canton_dim=cd)
    ...
    def offset_stripes_vertical(self):
        ...
        self.sd = self.fsc.center(scale_factor=uniform(0.3, 0.6))
    ...
    def canton(self):
        if self.layer2['fn'] is 'none':
            self.unicolor()
        self.sd = self.fsc.center_right(scale_factor=uniform(0.4, 0.55), width_fraction=0.75)
    ...
    def border(self):
        ...
        self.sd = self.fsc.default_center_center_left(scale_factor=uniform(0.3, 0.5))
    ...
    def cross(self):
        ...
        self.g.add(self.fc.line((0, self.h / 2), (self.w, self.h / 2),
                                 stroke=c, fill='none', stroke_width=wid))
        self.sd = self.fsc.center(scale_factor=uniform(0.1, 0.6))
    ...
    def nordic_cross(self):
        ...
        sf = uniform(0.1, 0.6)
        wf = (self.h/2) / self.w
        self.sd = self.fsc.center_left(scale_factor=sf, width_fraction=wf)
    ...
    def canton_cross(self):
        ...
        self.g.add(self.fc.line((0, self.h / 3), (self.w, self.h / 3),
                                 stroke=c, fill='none', stroke_width=wid))
        self.sd = self.fsc.canton_small(scale_factor=uniform(0.2, 0.33), dim=(1/3, 1/3))
    ...
    def pall(self):
        ...
        self.sd = self.fsc.center_left(scale_factor=scale_left, width_fraction=0.13)
